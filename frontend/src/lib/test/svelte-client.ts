...
type SvelteClientRuntime = Pick<typeof import('svelte'), 'mount' | 'unmount' | 'onDestroy'>;

// @ts-expect-error - Svelte does not publish declarations for this client runtime entry.
const clientRuntime = (await import('../../../node_modules/svelte/src/index-client.js')) as SvelteClientRuntime;

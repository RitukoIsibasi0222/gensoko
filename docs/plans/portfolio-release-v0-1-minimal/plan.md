...
2026-07-29にPR [#162](https://github.com/RitukoIsibasi0222/gensoko/pull/162)のmerge commit `4d3d8fb7425137c01337a81d3ff7d7c5bba29df6`から検証run [30406227957](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/30406227957)を別承認で実行した。`Validate confirmed migration`と`Verify v0.1 migration indexes`は成功し、migration run ID、対象SHA、v0.1対象5 indexの存在、`indisvalid`、`indisready`を値非表示で確認した。migration、backup、cleanup、deployのstepはすべてskipされ、M4を完了する。

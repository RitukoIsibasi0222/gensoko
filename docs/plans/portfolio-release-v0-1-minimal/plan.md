...
- [-] M6: 登録・メール認証・login・reload後の認証維持まで成功した。第五回Element seedは書込前module-load probeで`module_load_failure`へ停止し、元素0件・独立verify skipを維持している。Prisma Client生成修正のreview・main昇格・別承認付き成功までgame以降を停止する

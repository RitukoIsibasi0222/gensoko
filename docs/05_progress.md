...
- [-] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / bypass修正PR: [#205](https://github.com/RitukoIsibasi0222/gensoko/pull/205) / config path修正PR: [#208](https://github.com/RitukoIsibasi0222/gensoko/pull/208) / Vercel pull scope修正PR: [#211](https://github.com/RitukoIsibasi0222/gensoko/pull/211) / release PR: [#212](https://github.com/RitukoIsibasi0222/gensoko/pull/212) — release PR #209はdocs同期PR #210を含めowner merge済み。merge SHA `27d8b3e3849c0b3eff3ded764500ba5228b3ecf2`のrun [31145881782](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31145881782)はbranch・SHA・quality・DB target・migration・credential・API deploy・API healthまで同じSHAで成功した。Git未接続production projectへ`vercel pull`のbranch scopeを併用したためfrontend設定取得でfail-closed停止し、candidate deploy・promote・smoke・DB mutationは未実行、既存frontendを維持した。PDA-18のTDD修正・local/PR品質gate・Copilot reviewは完了し、PR #211はmerge SHA `e197449c564ba68d71d6cd11f9279e34eea3f28e`としてdevelopへowner merge済み。release PR #212でmain昇格を進める
...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / bypass修正PR: [#205](https://github.com/RitukoIsibasi0222/gensoko/pull/205) / config path修正PR: [#208](https://github.com/RitukoIsibasi0222/gensoko/pull/208) / Vercel pull scope修正PR: [#211](https://github.com/RitukoIsibasi0222/gensoko/pull/211) / release PR: [#212](https://github.com/RitukoIsibasi0222/gensoko/pull/212) — release PR #209のowner merge SHAでAPI deploy・healthまで成功した。run [31145881782](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31145881782)はGit未接続production Vercel projectの設定取得へbranch scopeを併用したためfrontend mutation前で停止し、旧frontendとDBを維持した。PDA-18のTDD修正・品質gate・Copilot reviewとPR #211のdevelop mergeは完了し、release PR #212のowner merge後にfrontend candidate→promote→smoke→evidenceのsame SHA検証を再開する
- [ ] 管理画面Playwright網羅

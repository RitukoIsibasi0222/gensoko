...
- [-] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / bypass修正PR: [#205](https://github.com/RitukoIsibasi0222/gensoko/pull/205) / config path修正PR: [#208](https://github.com/RitukoIsibasi0222/gensoko/pull/208) / Vercel pull scope修正PR: [#211](https://github.com/RitukoIsibasi0222/gensoko/pull/211) / prebuilt修正PR: [#214](https://github.com/RitukoIsibasi0222/gensoko/pull/214) / release PR: [#212](https://github.com/RitukoIsibasi0222/gensoko/pull/212) — release review follow-up PR #213を含むrelease PR #212はmerge SHA `dbfb7d2021ec1a5be29bcc0ecb6fe1a54d200346`としてmainへowner merge済み。run [31149586816](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31149586816)はbranch・SHA・quality・DB target・migration・credential・API deploy・API healthまで同じSHAで成功したが、branch scopeを除去した`vercel pull`もproduction設定取得でfail-closed停止した。candidate build/deploy・promote・smokeは未実行、safe evidence・cleanupは成功、DB mutationはなく既存frontendを維持した。PDA-19のprovider env pullを不要にするprebuilt buildはTDD修正・最終品質gateまで完了し、develop向けPR #214でreviewを進める
...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / bypass修正PR: [#205](https://github.com/RitukoIsibasi0222/gensoko/pull/205) / config path修正PR: [#208](https://github.com/RitukoIsibasi0222/gensoko/pull/208) / Vercel pull scope修正PR: [#211](https://github.com/RitukoIsibasi0222/gensoko/pull/211) / prebuilt修正PR: [#214](https://github.com/RitukoIsibasi0222/gensoko/pull/214) / release PR: [#212](https://github.com/RitukoIsibasi0222/gensoko/pull/212) — release PR #212のowner merge SHAでAPI deploy・healthまで成功した。run [31149586816](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31149586816)はbranch scope除去後も`vercel pull`でfrontend mutation前に停止し、safe evidence・cleanup成功、旧frontendとDBを維持した。PDA-19のrepository build・Build Output検証・prebuilt deploy修正はPR #214でreviewし、develop/main昇格後にfrontend candidate→promote→smoke→evidenceのsame SHA検証を再開する
- [ ] 管理画面Playwright網羅

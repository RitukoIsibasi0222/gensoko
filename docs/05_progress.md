...
- [-] develop merge後に固定staging frontendを自動更新する — Issue [#173](https://github.com/RitukoIsibasi0222/gensoko/issues/173) / PR: [#192](https://github.com/RitukoIsibasi0222/gensoko/pull/192), [#193](https://github.com/RitukoIsibasi0222/gensoko/pull/193), [#194](https://github.com/RitukoIsibasi0222/gensoko/pull/194), [#195](https://github.com/RitukoIsibasi0222/gensoko/pull/195), [#196](https://github.com/RitukoIsibasi0222/gensoko/pull/196), [#198](https://github.com/RitukoIsibasi0222/gensoko/pull/198), [#199](https://github.com/RitukoIsibasi0222/gensoko/pull/199), [#200](https://github.com/RitukoIsibasi0222/gensoko/pull/200) / 計画書: [`staging-frontend-auto-deploy`](plans/staging-frontend-auto-deploy/plan.md) — PR #199のmerge run [31090151492](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31090151492)は品質gate、exact `READY` Preview、develop先端再確認まで成功した。固定domainは最新UIと候補Previewと同じ14件のSvelteKit immutable assetを表示していたが、候補だけにVercel Toolbar markupが注入されHTML全体比較がtimeoutしたため、同一originの`/_app/immutable/` asset集合一致・両URLのmarkerを検証する方式へ修正中。production設定・deploymentは変更していない
...
- [-] develop frontend自動更新 — Issue [#173](https://github.com/RitukoIsibasi0222/gensoko/issues/173) / PR: [#192](https://github.com/RitukoIsibasi0222/gensoko/pull/192), [#198](https://github.com/RitukoIsibasi0222/gensoko/pull/198), [#199](https://github.com/RitukoIsibasi0222/gensoko/pull/199), [#200](https://github.com/RitukoIsibasi0222/gensoko/pull/200) / 計画書: [`staging-frontend-auto-deploy`](plans/staging-frontend-auto-deploy/plan.md) — provider注入markupを除外するimmutable asset fingerprint検証を実装中

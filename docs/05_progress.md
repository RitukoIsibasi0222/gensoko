...
- [x] フロントエンドUI調整（トップページ文言・ヘッダー挨拶・角丸4px統一・カード影削除）
...
- [-] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / latest follow-up PR: [#220](https://github.com/RitukoIsibasi0222/gensoko/pull/220) / latest release PR: [#221](https://github.com/RitukoIsibasi0222/gensoko/pull/221) — main SHA `4e7c16436c27468bd676c74394ba3bcb30820312`のrun [31167516423](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31167516423)はAPI healthとBuild Output contractまで成功し、Vercel CLI owner lookupでcandidate deployを安全停止した。PDA-24の既存Team ID明示scope修正と全local品質gateを完了し、PDA-16のcandidate→promote→smoke→evidence実production検証は未完了を維持する
...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / latest follow-up PR: [#220](https://github.com/RitukoIsibasi0222/gensoko/pull/220) / latest release PR: [#221](https://github.com/RitukoIsibasi0222/gensoko/pull/221) — run [31167516423](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31167516423)はAPI health後、Vercel CLI owner lookupでcandidate deployを安全停止し、旧frontend・DBを維持した。PDA-24のrepository修正と全local品質gateを完了し、review・develop/main昇格後にPDA-16を再開する

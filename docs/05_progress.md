...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) — 計画書作成済み。実装は計画PR merge後に別feature branchで着手する
- [ ] 管理画面Playwright網羅

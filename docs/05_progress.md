...
- [-] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / latest UI PR: [#224](https://github.com/RitukoIsibasi0222/gensoko/pull/224) / latest release PR: [#225](https://github.com/RitukoIsibasi0222/gensoko/pull/225) — tokenをAll Projects scopeへ更新したrun [31259602415](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31259602415)はproduction API healthとBuild Output contractまで成功し、Team IDをCLI slug scopeへ渡したcandidate deployで安全停止した。PDA-25の検証済みTeam slug修正と全local品質gateを完了し、review・develop/main昇格後にPDA-16を再開する
...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / latest UI PR: [#224](https://github.com/RitukoIsibasi0222/gensoko/pull/224) / latest release PR: [#225](https://github.com/RitukoIsibasi0222/gensoko/pull/225) — All Projects tokenでrun [31259602415](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31259602415)はAPI healthとBuild Output contractまで成功し、Team IDをslug scopeへ渡したcandidate deployで安全停止した。PDA-25のTeam slug修正をreview・develop/main昇格後にPDA-16で検証する

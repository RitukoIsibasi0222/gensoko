...
- [-] R6: 完全削除の残るv0.1 gateを完了する — 計画書: [`r6-account-deletion-gates`](plans/r6-account-deletion-gates/plan.md)
  - production本人削除専用config guard、main/recovery Playwright、manual-only workflow、runbookをTDD実装済み。関連49件、frontend全体661件、ESLint、Prettier、Svelte/TypeScript check、実行なしのPlaywright 2件収集は成功。T1B、T35、R13〜R16の承認付き実環境証拠が未完了のため`[-]`を維持する。

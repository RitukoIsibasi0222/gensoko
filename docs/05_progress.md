...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / prebuilt修正PR: [#214](https://github.com/RitukoIsibasi0222/gensoko/pull/214) / release PR: [#215](https://github.com/RitukoIsibasi0222/gensoko/pull/215) — run [31151482177](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31151482177)はAPI healthとrepository Build Output検証まで成功し、prebuilt candidate deployで停止した。旧frontend・DBを維持し、PDA-20のCLI境界・safe category修正をreview・develop/main昇格した後にcandidate→promote→smoke→evidenceのsame SHA検証を再開する
- [ ] 管理画面Playwright網羅

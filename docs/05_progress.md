...
- [x] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / latest follow-up PR: [#230](https://github.com/RitukoIsibasi0222/gensoko/pull/230) / latest release PR: [#231](https://github.com/RitukoIsibasi0222/gensoko/pull/231) — main SHA `e413d83170bd776e05afc24f4f453a5dff9f84eb`のrun [31265196631](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31265196631)でexact SHA quality、migration current、provider preflight、production API deploy/health、Git Integration由来`READY / STAGED`候補検証、REST promote、custom domain/API smoke、safe evidenceをすべて確認した。Vercel Auto-assign OFF、Root Directory=`frontend`、main-only Ignored Build Step、Git接続、Production Branch=`main`を保存し、公開画面で新SHAのCurrent、更新済み文言、2行の挨拶、4px radius、shadowなしを確認済み

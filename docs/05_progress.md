...
- [-] R7: app rate limitの実環境gateを完了する — 計画書: [`r7-rate-limit-environment-gates`](plans/r7-rate-limit-environment-gates/plan.md) — 2026-07-23再監査と実行計画作成済み。コード実装完了とR7完了を分離し、staging境界・WAF・production分離・監視・rollbackの証拠待ち

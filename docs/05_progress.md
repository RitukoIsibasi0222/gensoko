...
- [-] main merge後に承認付きでAPI → health → frontend → smokeを自動化する — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 計画PR: [#202](https://github.com/RitukoIsibasi0222/gensoko/pull/202) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / follow-up PR: [#205](https://github.com/RitukoIsibasi0222/gensoko/pull/205), [#208](https://github.com/RitukoIsibasi0222/gensoko/pull/208), [#211](https://github.com/RitukoIsibasi0222/gensoko/pull/211), [#214](https://github.com/RitukoIsibasi0222/gensoko/pull/214) / release PR: [#215](https://github.com/RitukoIsibasi0222/gensoko/pull/215) — merge SHA `0b6076687bad5ff42f11c76a16afe272a4c8f1ee`のrun [31151482177](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31151482177)はbranch・SHA・quality・DB target・migration・credential・API deploy・API health・repository build・Build Output contractまで成功し、prebuilt candidate deployでfail-closed停止した。promote・smokeは未実行、safe evidence・cleanup成功、DB mutationなし、APIだけ同SHAへ更新済みで旧frontendを維持した。PDA-20としてproduction CLIを`56.3.2`へ更新し、非対話project固定とraw非出力のsafe category分類をTDD実装・local品質gate完了、develop向けPR [#216](https://github.com/RitukoIsibasi0222/gensoko/pull/216)でreviewを進める
...
- [-] main承認付き通常release自動化 — Issue [#174](https://github.com/RitukoIsibasi0222/gensoko/issues/174) / 計画書: [`production-auto-deploy`](plans/production-auto-deploy/plan.md) / 実装PR: [#203](https://github.com/RitukoIsibasi0222/gensoko/pull/203) / prebuilt修正PR: [#214](https://github.com/RitukoIsibasi0222/gensoko/pull/214) / CLI境界修正PR: [#216](https://github.com/RitukoIsibasi0222/gensoko/pull/216) / release PR: [#215](https://github.com/RitukoIsibasi0222/gensoko/pull/215) — run [31151482177](https://github.com/RitukoIsibasi0222/gensoko/actions/runs/31151482177)はAPI healthとrepository Build Output検証まで成功し、prebuilt candidate deployで停止した。旧frontend・DBを維持し、PDA-20のCLI境界・safe category修正をreview・develop/main昇格した後にcandidate→promote→smoke→evidenceのsame SHA検証を再開する
